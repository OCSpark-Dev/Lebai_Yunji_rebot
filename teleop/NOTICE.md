...
- Phosphobot, commit `a5de051197c879e3c685d1362f649ce54ee47a3c`, MIT License. Its Meta Quest/VR WebSocket model and robot-side coordinate/kinematics path informed the architecture review; it is not the source of this repository's phone-gyroscope implementation.
